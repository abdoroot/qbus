<div class="w-full md:w-1/3 p-4">
    <div class="w-full mx-auto border rounded-lg md:mx-4 text-xl p-6">
        <label class="text-gray-700 text-xl font-bold" for="count">@lang('models/packageOrders.fields.count'):</label>
        <div class="block w-full items-center mt-1">
            {!! Form::open(['route' => 'packageOrders.store', 'id' => 'order-form']) !!}
                ...
                <div class="py-5">
                    <label class="text-lg font-medium text-gray-700 capitalize lg:text-xl dark:text-white">
                        @lang('models/packages.fields.additional')</label>
                    <div class="mt-3">
                        @foreach($additionals as $additional)
                        <div class="flex items-center">
                            @if(!is_null($packageAdditionals = $package->additionals()) && !is_null($addition = collect($packageAdditionals)->where('id', $additional->id)->first()))
                            <div class="">
                ...
                <div class="mt-5">
                    <strong>@lang('models/packageOrders.fields.fees') : </strong>
                    <span id="fees"
                        class="mx-2 text-gray-600">{{ $fees = $package->fees }}</span>
                </div>

                <div class="mt-5">
                    <strong>@lang('models/packages.fields.additional')   : </strong>
                    <span id="additional" class="mx-2 text-gray-600">0</span>
                </div>

              
                <div class="mt-3">
                    <strong>@lang('models/packageOrders.fields.tax') : </strong>
                    <span id="tax"
                        class="mx-2 text-gray-600">{{ $tax_amount }}</span>
                </div>
                <div class="mt-2">
                    <strong>@lang('models/packageOrders.fields.total') : </strong>
                    <span id="total"
