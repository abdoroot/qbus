<div class="table-responsive m-t-30 m-b-20">
    <table id="additionals-table" class="table display table-bordered table-striped no-wrap">
        <thead>
            <tr>
                <th>@lang('crud.id')</th>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $additional->id }}</td>
                <td>
                    <a href="{{ route('admin.additionals.show', $additional->id) }}">{{ $additional->name }}</a></td>
                <td>{!! $additional->icon !!}</td>
                <td>
                    <a href="{{ route('admin.additionals.edit', [$additional->id]) }}"
                        class='btn btn-info btn-sm'>
                            <i class="ti-pencil"></i>
                        </a>
                    {!! Form::open(['route' => ['admin.additionals.destroy', $additional->id], 'method' => 'delete', 'class' => 'd-inline']) !!}
