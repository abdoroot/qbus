<div class="table-responsive m-t-30 m-b-20">
    <table id="categories-table" class="table display table-bordered table-striped no-wrap">
        <thead>
            <tr>
                <th>@lang('crud.id')</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    {!! Form::open(['route' => ['admin.categories.destroy', $category->id], 'method' => 'delete', 'class' => 'd-inline']) !!}
