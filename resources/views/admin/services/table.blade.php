<div class="table-responsive m-t-30 m-b-20">
    <table id="services-table" class="table display table-bordered table-striped no-wrap">
        <thead>
            <tr>
                <th>@lang('crud.id')</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="white-space: normal;">{{ $service->text }}</td>
                ...
                <td>
                    ...
                    {!! Form::open(['route' => ['admin.services.destroy', $service->id], 'method' => 'delete', 'class' => 'd-inline']) !!}
