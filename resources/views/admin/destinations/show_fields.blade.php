...
<tr>
    ...
    <td>
        @if(!is_null($provider = $destination->provider))
...
<tr>
    ...
    <td>
        @if(!is_null($fromCity = $destination->fromCity))
        <a href="{{ route('admin.cities.show', $fromCity->id) }}">{{ $fromCity->name }}</a>
        @endif
    </td>
</tr>
...
<tr>
    ...
    <td>
        @if(!is_null($toCity = $destination->toCity))
        <a href="{{ route('admin.cities.show', $toCity->id) }}">{{ $toCity->name }}</a>
        @endif
    </td>
</tr>
...
<tr>
    ...
    <td>
        ...
        <a href="{{ route('admin.terminals.show', $startingTerminal->id) }}">{{ $startingTerminal->name }}</a>
        @endif
    </td>
</tr>
...
<tr>
    ...
    <td>
        <ul>
            ...
            <li>
                <a href="{{ route('admin.terminals.show', $stopTerminal->id) }}" class="text-primary">{{ $stopTerminal->name }}</a> 
            </li>
            @endforeach
        </ul>
    </td>
...
<tr>
    ...
    <td>
        ...
        <a href="{{ route('admin.terminals.show', $arrivalTerminal->id) }}">{{ $arrivalTerminal->name }}</a>
        @endif
    </td>
</tr>
