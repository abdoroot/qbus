<div class="table-responsive m-t-30 m-b-20">
    <table id="emails-table" class="table display table-bordered table-striped no-wrap">
        <thead>
            <tr>
                <th>@lang('crud.id')</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    {!! Form::open(['route' => ['admin.emails.destroy', $email->id], 'method' => 'delete', 'class' => 'd-inline']) !!}
