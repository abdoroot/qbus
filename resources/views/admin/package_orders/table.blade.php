        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('admin.packages.show', $package->id) }}">{{ $package->name }}</a>
                    @endif
                </td>
                <td>
                ...
                <td>
                    <a href="{{ route('admin.packageOrders.show', [$packageOrder->id]) }}"
                        class='btn btn-info btn-sm'>
                            <i class="ti-pencil"></i>
                        </a>
                    {!! Form::open(['route' => ['admin.packageOrders.destroy', $packageOrder->id], 'method' => 'delete', 'class' => 'd-inline']) !!}
