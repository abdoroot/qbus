<div class="row">
    <div class="col-md-12">
        <div class="float-left">
            <address>
                ...
                <h3>
                    <a href="{{ route('admin.providers.show', $provider->id) }}"><b class="text-danger">{{ $provider->name }}</b></a>
                </h3>
    ...
    <div class="col-sm-12">
        ...
        <small class="text-muted"> @lang('models/packageOrders.fields.admin_notes') :</small>
        <p>{{ $packageOrder->admin_notes ?? '-' }}</p>
