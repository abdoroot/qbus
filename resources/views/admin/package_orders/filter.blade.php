<div class="card col-sm-12 collapse" id="filter-form">
    <div class="card-body">
        {!! Form::open(['route' => 'admin.packageOrders.index', 'method' => 'get', 'class' => 'row']) !!}

            <!-- Provider Id Field -->
            <div class="form-group col-sm-6">
                {!! Form::label('provider_id', __('models/packageOrders.fields.provider_id').':') !!}
            ...
            <div class="col-sm-12">
                <div class="float-right">
                    ...
                    <a href="{{ route('admin.packageOrders.index') }}" class="btn btn-dark">@lang('crud.reset')</a>
                </div>
            </div>
