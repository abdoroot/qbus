...
@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('admin.reviews.index') }}">@lang('models/reviews.plural')</a></li>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-footer">
                    <a class="btn btn-dark" href="{{ route('admin.reviews.index') }}">@lang('crud.back')</a>
                </div>
            </div>
        </div>
    </div>

    @include('admin.reviews.edit_modal')  
@endsection