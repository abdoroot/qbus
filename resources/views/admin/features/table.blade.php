<div class="table-responsive m-t-30 m-b-20">
    <table id="features-table" class="table display table-bordered table-striped no-wrap">
        <thead>
            <tr>
                <th>@lang('crud.id')</th>
                <th>@lang('models/features.fields.title')</th>
                <th>@lang('models/features.fields.text')</th>
                {{-- <th>@lang('models/features.fields.icon')</th> --}}
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $feature->id }}</td>
                <td><a href="{{ route('admin.features.show', $feature->id) }}">{{ $feature->title }}</a></td>
                <td style="white-space: normal;">{{ $feature->text }}</td>
                {{-- <td>{{ $feature->icon }}</td> --}}
                <td>
                    ...
                    {!! Form::open(['route' => ['admin.features.destroy', $feature->id], 'method' => 'delete', 'class' => 'd-inline']) !!}
