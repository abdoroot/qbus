<div id="cancel-modal" class="modal" tabindex="-1" role="dialog" aria-labelledby="vcenter" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            {!! Form::model($busOrder, ['route' => ['admin.busOrders.update', $busOrder->id], 'method' => 'patch', 'id' => 'bus-order-form']) !!}
            ...
            <div class="modal-body">  
                ...
                <!-- Admin Notes Field -->
                <div class="form-group">
                    {!! Form::label('admin_notes', __('models/busOrders.fields.admin_notes').':') !!}
