<div class="card col-sm-12 collapse" id="filter-form">
    <div class="card-body">
        {!! Form::open(['route' => 'admin.coupons.index', 'method' => 'get', 'class' => 'row']) !!}
            <!-- Provider Id Field -->
            <div class="form-group col-sm-6">
                {!! Form::label('provider_id', __('models/coupons.fields.provider_id').':') !!}
            ...
            <div class="col-sm-12">
                <div class="float-right">
                    ...
                    <a href="{{ route('admin.coupons.index') }}" class="btn btn-dark">@lang('crud.reset')</a>
                </div>
            </div>
