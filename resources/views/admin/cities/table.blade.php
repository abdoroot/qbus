<div class="table-responsive m-t-30 m-b-20">
    <table id="cities-table" class="table display table-bordered table-striped no-wrap">
        <thead>
            <tr>
                <th>@lang('crud.id')</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    {!! Form::open(['route' => ['admin.cities.destroy', $city->id], 'method' => 'delete', 'class' => 'd-inline']) !!}
