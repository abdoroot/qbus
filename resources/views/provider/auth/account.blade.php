...
@section('title', __('auth.provider.account'))
            ...
            <div class="flex flex-col md:flex-row">
                <div class="hidden bg-cover lg:block lg:w-1/2"
                    ...
                    <div class="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
                        <div>
                            <h2 class="text-4xl font-bold text-white">@lang('msg.provider_account_side_title')</h2>
                            <p class="max-w-xl mt-3 text-gray-300 text-xl">@lang('msg.provider_account_side_text')</p>
                        </div>
                    </div>
                </div>
                <div class="flex items-center justify-center p-6 sm:p-12 lg:w-1/2">
                    <div class="w-full">
                        ...
                        <h6 class="mb-4 text-sm">@lang('msg.step') 3/3</h6>
                        <h3 class="mb-4 text-xl font-bold text-blue-600">@lang('auth.account.title')</h3>
                        ...
                        <div class="mt-8">
                            {!! Form::open(['route' => ['provider.account', $provider_id], 'type' => 'post', 'id' => 'registerform']) !!}
                                <div>
                                    {!! Form::label('username', __('models/accounts.fields.username').'*', ['class' => 'text-base text-gray-600 dark:text-gray-200']) !!}
                                    <input type="text"
                                        name="username"
                                ...
                                <div class="mt-6">
                                    {!! Form::label('password', __('models/accounts.fields.password').'*', ['class' => 'text-base text-gray-600 dark:text-gray-200']) !!}
                                    <input type="password"
                                        name="password"
                                        class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40 text-base 
