...
<a href="{{ route('provider.accounts.create') }}" class="btn btn-info"><i class="fa fa-plus-circle"></i> @lang('crud.add_new')</a>
@endsection
...
<div class="row">
    ...
    @include('provider.accounts.filter')
    <div class="card col-sm-12">
        <div class="card-body p-0">
            @include('provider.accounts.table')
        </div>
    </div>
</div>
