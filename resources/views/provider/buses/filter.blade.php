<div class="card col-sm-12 collapse" id="filter-form">
    <div class="card-body">
        {!! Form::open(['route' => 'provider.buses.index', 'method' => 'get', 'class' => 'row']) !!}
            <!-- Plate Field -->
            ...
            <!-- Rate Field -->
            <div class="form-group col-sm-6">
                {!! Form::label('rate', __('models/buses.fields.rate').':') !!}
                <div class="row">
                    <div class="form-group col-sm-4">
            ...
            <div class="col-sm-12">
                <div class="float-right">
                    ...
                    <a href="{{ route('provider.buses.index') }}" class="btn btn-dark">@lang('crud.reset')</a>
                </div>
            </div>
