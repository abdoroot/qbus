    ...
    <table id="trip_orders-table" class="table display table-bordered table-striped no-wrap">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    @if(!is_null($user = $tripOrder->user)){{ $user->name }}@endif
                </td>
                ...
                <td>
                    <a href="{{ route('provider.tripOrders.show', [$tripOrder->id]) }}"
                        class='btn btn-info btn-sm'>
                            <i class="ti-pencil"></i>
                        </a>
                    {!! Form::open(['route' => ['provider.tripOrders.destroy', $tripOrder->id], 'method' => 'delete', 'class' => 'd-inline']) !!}
