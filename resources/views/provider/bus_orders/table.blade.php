        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('provider.buses.show', $bus->id) }}"> {{ $busOrder->bus->plate }}</a>
                    @endif    
                </td>
                <td>{{ $busOrder->total }}</td>
                <td>{!! $busOrder->status_span !!}</td>
                <td>
                    <a href="{{ route('provider.busOrders.show', [$busOrder->id]) }}"
                        class='btn btn-info btn-sm'>
                            <i class="ti-pencil"></i>
                        </a>
                    {!! Form::open(['route' => ['provider.busOrders.destroy', $busOrder->id], 'method' => 'delete', 'class' => 'd-inline']) !!}
