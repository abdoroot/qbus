...
<a href="{{ route('provider.packageOrders.create') }}" class="btn btn-info"><i class="fa fa-plus-circle"></i> @lang('crud.add_new')</a>
@endsection
...
<div class="row">
    ...
    @include('provider.package_orders.filter')
    <div class="card col-sm-12">
        <div class="card-body p-0">
            @include('provider.package_orders.table')
        </div>
    </div>
</div>
