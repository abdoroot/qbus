    ...
    <table id="trips-table" class="table display table-bordered table-striped no-wrap">
        <thead>
            <tr>
                ...
                <th>@lang('models/trips.fields.destination')</th>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $trip->id }}</td>
                {{-- <td><a href="{{ route('provider.trips.show', [$trip->id]) }}">{{ $trip->name }}</a></td> --}}
                ...
                <td>
                    ...
                    <a href="{{ route('provider.trips.edit', [$trip->id]) }}"
                        class='btn btn-info btn-sm'>
                            <i class="ti-pencil"></i>
                        </a>
                    {!! Form::open(['route' => ['provider.trips.destroy', $trip->id], 'method' => 'delete', 'class' => 'd-inline']) !!}
