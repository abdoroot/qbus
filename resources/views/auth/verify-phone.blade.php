    ...
    <div class="flex items-center min-h-screen bg-gray-50 mb-8">
        <div class="flex-1 h-full mx-auto bg-white rounded-lg">
            <div class="flex flex-col md:flex-row">
                <div class="hidden bg-cover lg:block md:w-1/2"
                    style="background-image: url(public/design/assets/img/40.jpg)">
                    <div class="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
                        <div>
                            <h2 class="text-4xl font-bold text-white">@lang('msg.verify_side_title')</h2>
                            <p class="max-w-xl mt-3 text-gray-300 text-xl">@lang('msg.verify_side_text')</p>
                        </div>
                    </div>
                </div>
                <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                    <div class="w-full">
                        ...
                        <div class="mt-8">
                            ...
                            {!! Form::close() !!}
                            <p class="mt-6 text-base text-center"> @lang('auth.registration.have_membership')                                  
