    ...
    <div class="flex justify-center h-screen">
        ...
        <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-1/2">
            <div class="w-full max-w-sm p-6 m-auto bg-white rounded-md dark:bg-gray-800 my-32">
                ...
                <h1 class="text-xl font-semibold text-center text-gray-700 dark:text-white">@lang('auth.reset_password.phone_title')</h1>
                {!! Form::open(['route' => 'phone.reset', 'type' => 'post', 'class' => 'mt-10']) !!}
                    <div>
                        {!! Form::label('phone', __('auth.phone'), ['class' => 'block text-lg text-gray-800 dark:text-gray-200']) !!}
                        <input type="phone"
                            name="phone"
                            value="{{ old('phone') }}"
                    ...
                    <div>
                        {!! Form::label('token', __('auth.token'), ['class' => 'block text-lg text-gray-800 dark:text-gray-200']) !!}
                        <input type="token"
                            name="token"
                            value="{{ old('token') }}"
                            class="@error('token') border-red-500 @enderror 
                                text-lg block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
                    ...
                    <div class="mt-6">
                        <button
                            ...
                            @lang('auth.reset_password.reset_pwd_btn_phone') </button>
                    </div>
                {!! Form::close() !!}
            </div>
        </div>
