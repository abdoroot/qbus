<div class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="w-full bg-white printableArea">
        @include('user.trip_orders.show_header')
        
        @include('user.trip_orders.show_details')

        @include('user.trip_orders.show_tickets')
        
        @include('user.trip_orders.show_total')

        @include('user.trip_orders.show_footer')
        <div class="p-4">
...
<div class="flex items-end justify-end space-x-3 mt-5">
    ...
    @endif
    <a href="{{ route('tripOrders.index') }}" class="px-4 py-2 text-sm text-white bg-gray-600">@lang('crud.back')</a>
</div>