...
<div class="mt-5">
    {!! Form::open(['route' => ['busOrders.update', $busOrder->id], 'method' => 'patch', 'id' => 'order-form']) !!}
    <div class="mt-5">
        <label class="text-gray-700 dark:text-gray-200" for="comment">@lang('models/busOrders.fields.user_notes')</label>
