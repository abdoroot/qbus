<div class="row">
    <div class="col-md-12">
        <div class="float-left">
            <address>
                ...
                <h3><b class="text-danger">{{ $provider->name }}</b></h3>
                <p class="text-muted m-l-5">{{ $provider->address }},
                    ...
                    <a href="javascript:;" data-toggle="modal" data-target="#bus-modal">
                        <i class="ti-truck"></i> {{ $bus->plate }}
                    </a>
                    @include('user.bus_orders.bus_modal')    
                    @else - @endif
                </p>
                @endif
            </address>
        ...
        <div class="float-right text-right">
            <address>
                ...
                <h4><i class="icon-user"></i> {{ $user->name }}</h4>
    ...
    <div class="col-md-12">
        <div class="float-right m-t-30 text-right">
            <h3><b>@lang('models/busOrders.fields.fees') :</b> {{ $busOrder->fees }}</h3>
        </div>
    </div>
</div>